...
convenience of readers, the dataset is provided in the folder '[filtered_feature_bc_matrix_MemSeqData](https://doi.org/10.5281/zenodo.20355272)' inside the zip file named CellMemPowerSeek.zip. If you download barcodes.tsv.gz, features.tsv.gz, matrix.mtx.gz separately, please keep them together in a folder named 'filtered_feature_bc_matrix_MemSeqData'.
