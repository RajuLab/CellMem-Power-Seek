...
convenience of readers, the dataset is provided in this Dropbox folder as '[filtered_feature_bc_matrix_MemSeqData](https://www.dropbox.com/scl/fo/7j78zvysdrp2nhfgn94lz/AHHtWTzIqUcP7u_Q4r_2jOs?rlkey=m6mvd6jplj62rsfgy0af0qa91&st=l8555qqi&dl=0)'. It can also be found in the corresponding Zenodo folder. (If you download barcodes.tsv.gz, features.tsv.gz, matrix.mtx.gz separately, please keep them together in a folder named 'filtered_feature_bc_matrix_MemSeqData'.)
