...
Importing 10x scRNA-seq count matrix dataset. Please set the path according to your file location. 

```{r setting up Path}
# Please set up the path according to your scRNA raw count data path.
...
#This step is very specific to the data used here. It's not related to general preprocessing steps. 'r1' and 'r2' represent different batches here.
# assigning wells number to each sample
